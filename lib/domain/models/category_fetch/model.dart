...
class CategoryFetchModel {
  final String id;
  final String subCategory;
  final int? circuitRestTime; // Made nullable
  final int? circuitReps; // Made nullable
  final List<CategoryExercisesClass> exercises;
  final DateTime createdAt;
  final DateTime updatedAt;
  final int? version; // Made nullable
  ...
  factory CategoryFetchModel.fromJson(Map<String, dynamic> json) {
    return CategoryFetchModel(
      id: json['_id'],
      subCategory: json['sub_category'],
      circuitRestTime: json['circuit_rest_time'] ?? 0, // Default to 0 if null
      circuitReps: json['circuit_reps'] ?? 0, // Default to 0 if null
      exercises: (json['exercises'] as List)
          .map((e) => CategoryExercisesClass.fromJson(e))
          .toList(),
      createdAt: DateTime.parse(json['createdAt']),
...
class CategoryExercisesClass {
  ...
  final bool weighted;
  final int sets;
  final List<int>? reps; // Made nullable
  final String? setTime; // Made nullable
  final List<String> supersetNames;
  final int restTime;
  final String videoUrl;
  final String imageUrl;
