...
class PlanOverviewModel {
  ...
  factory PlanOverviewModel.fromJson(Map<String, dynamic> json) {
    return PlanOverviewModel(
      ...
      averageCaloriesBurnedPerMinute:
          (json['average_calories_burned_per_minute'] ?? 0).toDouble(),
      weeks: List<Week>.from(
          (json['weeks'] ?? []).map((week) => Week.fromJson(week))),
    );
  }
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) {
    return Category(
      id: json['_id'] ?? '',
      subCategory: json['sub_category'] ?? '',
      circuitRestTime: json['circuit_rest_time'] ?? 0,
      circuitReps: json['circuit_reps'] ?? 0,
...
class Exercise {
  ...
  factory Exercise.fromJson(Map<String, dynamic> json) {
    return Exercise(
      id: json['_id'] ?? '',
      name: json['name'] ?? '',
      exerciseNumber: json['exercise_number'] ?? 0,
      exerciseType: json['exercise_type'] ?? '',
      timeBased: json['time_based'] ?? '',
      weighted: json['weighted'] ?? '',
      sets: json['sets'] ?? 0,
